...
#user1
user1.user_book_relations.create(:user_id => user1.id, :book_id => book1.id)
#user2
user2.user_book_relations.create(:user_id => user2.id, :book_id => book1.id)
user2.user_book_relations.create(:user_id => user2.id, :book_id => book2.id)
#user3
user3.user_book_relations.create(:user_id => user3.id, :book_id => book1.id)
user3.user_book_relations.create(:user_id => user3.id, :book_id => book2.id)
user3.user_book_relations.create(:user_id => user3.id, :book_id => book3.id)
#user4
user4.user_book_relations.create(:user_id => user4.id, :book_id => book1.id)
user4.user_book_relations.create(:user_id => user4.id, :book_id => book2.id)
user4.user_book_relations.create(:user_id => user4.id, :book_id => book3.id)
user4.user_book_relations.create(:user_id => user4.id, :book_id => book4.id)
#user5
user5.user_book_relations.create(:user_id => user5.id, :book_id => book1.id)
user5.user_book_relations.create(:user_id => user5.id, :book_id => book2.id)
user5.user_book_relations.create(:user_id => user5.id, :book_id => book3.id)
user5.user_book_relations.create(:user_id => user5.id, :book_id => book4.id)
user5.user_book_relations.create(:user_id => user5.id, :book_id => book5.id)
